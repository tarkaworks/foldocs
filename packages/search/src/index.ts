...
export const SearchDocument = S.Struct({
  ...
  url: S.String,
  title: S.String,
  type: S.optionalKey(S.Literals(['page', 'section'])),
  pageId: S.optionalKey(S.String),
  pageTitle: S.optionalKey(S.String),
  sectionId: S.optionalKey(S.String),
  breadcrumbs: S.optionalKey(S.Array(S.String)),
